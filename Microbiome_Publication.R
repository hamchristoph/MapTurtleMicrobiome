...
overallphy = qza_to_phyloseq(
  ...
  tree="NMTtreeFinal2022.qza",
  taxonomy="NMTtaxonomy2022.qza",
...
#read in taxonomy
taxonswab = read_qza("NMTtaxonomy2022.qza")$data%>% parse_taxonomy()
...
phyldammerge + labs(x ="\nDam Relativity", y = "Percentage\n", title="Cloacal Samples") + theme(plot.title = element_text(size = 19, face = "bold"), strip.text = element_blank(),axis.title.x = element_text(size=17), axis.title.y = element_text(size=17), axis.text.x = element_text(size=16), axis.text.y = element_text(size=16), legend.title=element_text(size=16), legend.background = element_rect(linetype ="solid", size=1, colour="black"), legend.text = element_text(size=12)) + guides(fill=guide_legend(title="Phylum")) + scale_fill_brewer(name = "Phylum", palette = "Spectral", labels=c("Other", "Acidobacteriota (synonym: Acidobacteria)", "Fusobacteriota (synonym:Fusobacteria)", "Chloroflexota (synonym: Chloroflexi)", "Cyanobacteriota (synonym: Cyanobacteria)", "N/A", "Deinococcota (synonym: Deinococcus-Thermus)", "Actinomycetota (synonym: Actinobacteria)", "Bacillota (synonym: Firmicutes)", "Bacteroidota (synonym:Bacteroidetes)", "Pseudomonadota (synonym: Proteobacteria)"))


###oral samples dam relativity
ASVOralDam = read_qza("Oraltable_grouped_80kdam.qza")$data
taxonoral = read_qza("NMTtaxonomy2022.qza")$data%>% parse_taxonomy()
...
#phylum
phylDamOralmerge + labs(x ="\nDam Relativity", y = "Percentage\n", title="Oral Samples") + theme(plot.title = element_text(size = 19, face = "bold"), strip.text = element_blank(),axis.title.x = element_text(size=17), axis.title.y = element_text(size=17), axis.text.x = element_text(size=16), axis.text.y = element_text(size=16), legend.title=element_text(size=16), legend.background = element_rect(linetype ="solid", size=1, colour="black"), legend.text = element_text(size=12)) + guides(fill=guide_legend(title="Phylum")) + scale_fill_brewer(name = "Phylum", palette = "Spectral", labels=c("Other", "Minisyncoccota", "Synergistota", "Chloroflexota (synonym: Chloroflexi)","Cyanobacteriota (synonym:Cyanobacteria)", "N/A", "Actinomycetota (synonym:Actinobacteria)", "Deinococcota (synonym: Deinococcus-Thermus)", "Bacillota (synonym:Firmicutes)", "Bacteroidota (synonym:Bacteroidetes)", "Pseudomonadota (synonym:Proteobacteria"))
